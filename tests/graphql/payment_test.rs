...
//     // Insertar pagos en Redis en el mismo formato que producción:
//     // ["[{...}]"]
...
//         let payment_json_string =
//             serde_json::to_string(&payment_array).expect("Failed to serialize payment array");
//         let redis_value = format!("[\"{}\"]", payment_json_string);

//         con.json_set::<String, &str, String, ()>(payment_key, "$", &redis_value)
